module TypeProviderWithThothTests
...
type Generative2 = TypeProviderWithThoth.GenerativeProvider<2>
type Generative4 = TypeProviderWithThoth.GenerativeProvider<4>
